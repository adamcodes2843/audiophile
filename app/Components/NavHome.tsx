...
const NavHome = () => {
  return (
    <nav className="py-6 px-8 md:px-0 flex justify-between md:justify-start items-center text-audiocolor-w1 w-full md:w-11/12 lg:w-10/12 z-10 absolute border-b-[1px] border-audiocolor-w1 border-opacity-10 md:mx-10 md:left-0 md:right-0 lg:mx-auto max-w-[1080px]">
