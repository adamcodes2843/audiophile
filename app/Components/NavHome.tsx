...
const NavHome = () => {
  ...
  return (
    <>
    <nav className={`py-8 px-8 md:px-10 lg:px-0 md:mx-auto flex justify-between md:justify-start  lg:w-10/12 items-center text-audiocolor-w1 w-full z-50 lg:border-b-[1px] lg:border-audiocolor-w1 lg:border-opacity-10 ${showCategories ? 'fixed bg-audiocolor-b1 lg:bg-opacity-0' : 'absolute'} lg:absolute md:left-0 md:right-0 lg:mx-auto max-w-[1080px]`}>
