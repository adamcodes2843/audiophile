...
const HomeProductCards = () => {
  let HomeEarphones = '/../assets/home/mobile/image-earphones-yx1.jpg'
  let HomeSpeakerZX7 = '/../assets/home/mobile/image-speaker-zx7.jpg'
  let HomeSpeakerZX9 = '/../assets/home/mobile/image-speaker-zx9.png'
  return (
    <section className='flex flex-col w-full px-6 gap-6 mt-40'>
      <figure className="flex flex-col items-center text-center px-4 py-16 gap-7 rounded-lg bg-audiocolor-oj2 w-full overflow-hidden relative text-audiocolor-w1">
        <img src={HomeSpeakerZX9} alt="ZX9 SPEAKERS" className='w-40 mb-2' />
        ...
        <Link href='/products/zx9-speaker' className='w-40 py-3 text-center bg-audiocolor-b2'>SEE PRODUCT</Link>
      ...
      <figure className='relative'>
        <img src={HomeSpeakerZX7} alt='ZX7 SPEAKERS' className='rounded-lg relative' />
      ...
      <figure>
        <img src={HomeEarphones} alt='YX1 EARPHONES' className="rounded-lg" />
