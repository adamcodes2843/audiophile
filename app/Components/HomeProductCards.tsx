...
const HomeProductCards = () => {
  ...
  return (
    <section className='flex flex-col w-full mb-32 md:mb-24 px-6 lg:px-40 md:px-10 gap-6 md:gap-8 lg:gap-12 mt-40 md:mt-20 lg:mt-32'>
      <figure className="flex flex-col items-center text-center px-4 py-16 gap-7 rounded-lg bg-audiocolor-oj2 w-full overflow-hidden relative text-audiocolor-w1">
        ...
        <Link href='/products/zx9-speaker' className='w-40 py-3 text-center bg-audiocolor-b2 md:mt-4 z-50'>SEE PRODUCT</Link>
      ...
      <figure className='relative w-full'>
        ...
        <figcaption className='ml-6 md:ml-16 lg:ml-20 absolute top-0 flex flex-col gap-7 h-full '>
          ...
          <Link href='/products/zx7-speaker' className='border-[1px] py-3 text-center w-40'>SEE PRODUCT</Link>
          </div>
        </figcaption>
      </figure>
      <figure className="grid grid-cols-1 grid-rows-2 md:flex md:w-full md:gap-3 lg:gap-8">
        ...
        <figcaption className="bg-audiocolor-w3 mt-5 pl-3 md:px-0 flex flex-col justify-center gap-6 md:gap-8 md:w-1/2 rounded-lg md:mt-0">
          ...
          <Link href='/products/yx1-earphones' className='border-[1px] w-40 py-3 px-8 text-center'>SEE PRODUCT</Link>
          </div>
        </figcaption>
      </figure>
    </section>
