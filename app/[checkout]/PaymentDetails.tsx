  ...
  return (
    <fieldset className="grid grid-cols-1 md:grid-cols-2 mb-6">
        ...
        <h5 className="mt-4 mb-2 text-subtitle md:row-span-2">Payment Method</h5>
            ...
            <input type="radio" id="eMon" name="payment_method" value="e-Money" className='mr-3 hover:cursor-pointer accent-audiocolor-oj2 w-5 h-5' defaultChecked onClick={() => ePay()} />
                e-Money
            </label>
            ...
            <input type="radio" id="CoD" name="payment_method" value="cash on delivery" className="mr-3 hover:cursor-pointer accent-audiocolor-oj2 w-5 h-5" onClick={() => onDelivery()} />
                Cash on Delivery
            </label>
        {
